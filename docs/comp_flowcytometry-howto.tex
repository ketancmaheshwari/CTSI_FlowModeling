...
Request an account: \texttt{http://core.sam.pitt.edu/apply}\\
...
\texttt{\textbf{cd \emph{adir}} \#change to adir}\\
\texttt{\textbf{cd } \#change to the home dir}\\
\texttt{\textbf{cat \emph{afile}} \#display contents of afile}\\
\texttt{\textbf{cp file1 file2} \#copy file1 to file2}\\
\texttt{\textbf{mv file1 file2} \#rename file1 to file2}\\
\texttt{\textbf{mv file1 \emph{adir}/} \#move file1 to \emph{adir}}\\
\texttt{\textbf{touch afile} \#create a new file}\\
\texttt{\textbf{rm \emph{filename}} \#delete a file afilename}\\
\texttt{\textbf{mkdir \emph{adir}} \#create a new dir}\\
...
\begin{enumerate}
\item Ensure that you have an account current with CRC. See the help section on this document for more.
\item Open a command prompt terminal on your computer, usually the terminal program on Mac OS
\item Log in to the \texttt{HTC} cluster at CRC: \texttt{ssh \emph{pittID}@htc.sam.pitt.edu}
...
\texttt{scp -r \emph{pittID}@htc.sam.pitt.edu:~/borghesilab/home-experiments/results .}
\end{enumerate}
